                        ...
                        <div class="flex_center">
                            ...
                            <div class="variable-width">
                                ...
                                <div class="slide_dir">
                                    ...
                                    <h3><?php print(substr($project["Title_project_site"],0,69));?></h3>
                                    <p><?php print(substr($project["Opisanie_project_site"],0,69));?></p>
                                    <a href="projects.php?id=<?php print($project["Title_project_site"]); ?>" class="learn_more" >Читать подробнее
