        ...
        <form action="../include/save.php" method="POST" enctype="multipart/form-data">
            <div class="recentOrders aboutOrders projectTable toggle_accordion1">
                <div class="cardHeader">
                    ...
                    <input type="text" name="fun" style="width: 100%; display: none; " value="newProduct">
                </div>
                <table>
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <tr>
                            <td>
                                <h4>Основное изображение продукта на главной странице<span class="necessarily"> *</span></h4>
                            </td>
                            <td width="60px">
